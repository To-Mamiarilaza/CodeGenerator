...
export default function TypeLanguageForm() {
  ...
  useEffect(() => {
    ...
    if (id !== undefined) {
      axios
        .get(API_BASE_URL + "/typeLanguages/" + id, {headers: {"Authorization": "Bearer " + localStorage.getItem("apktoken")}})
        .then((response) => {
  ...
  const saveTypeLanguage = (e) => {
    ...
    if (id === undefined) {
      axios
      .post(API_BASE_URL + "/typeLanguages", newTypeLanguage, {headers: {"Authorization": "Bearer " + localStorage.getItem("apktoken")}})
        .then((response) => {
      ...
      axios
        .put(API_BASE_URL + "/typeLanguages/" + id, newTypeLanguage, {headers: {"Authorization": "Bearer " + localStorage.getItem("apktoken")}})
        .then((response) => {
          navigate("/typeLanguages");
        })
        .catch((error) => {
